  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-72 flex items-center justify-between border border-yellow-400 px-4 py-2 text-sos-primary-blue font-medium text-lg hover:text-sos-secondary-blue"
        aria-haspopup="true"
        aria-expanded={open}
      >
        {/* Globe Icon */}
        ...
        <span className="text-xl text-[20px] text-sos-primary-gold font-medium">{currentLang}</span>

        {/* Downward chevron */}
        <svg width="26" height="16" viewBox="0 0 26 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.7393 14.6189C12.4366 15.3162 13.569 15.3162 14.2663 14.6189L24.977 3.90819C25.6743 3.21088 25.6743 2.07845 24.977 1.38114C24.2797 0.683827 23.1473 0.683827 22.45 1.38114L13 10.8311L3.55004 1.38672C2.85273 0.689405 1.72029 0.689405 1.02298 1.38672C0.325672 2.08403 0.325672 3.21646 1.02298 3.91377L11.7337 14.6245L11.7393 14.6189Z" fill="#1C6EAA" />
        </svg>
      </button>
          ...
          <ul className="divide-y divide-sos-primary-blue">
            {languages.map((lang) => (
              <li
                ...
                className={clsx(
                  'px-4 py-3 cursor-pointer text-center text-xl text-[20px] font-medium text-sos-primary-blue hover:bg-sos-secondary-gold',
